...
describe('issues/OPT-A bundle packing', () => {
  it('packs independent single-PE bundles into fewer bundles', () => {
    const source = `
target "uma-cgra-base";
kernel "opt_a_pack" {
  std::latency_hide(window=2, mode=conservative);
...
`;
  ...
  it('keeps route-dependent bundles unmerged as a safety guard', () => {
    const source = `
target "uma-cgra-base";

...
export const NOOP_ADVANCED_STATEMENTS = new Set<string>([
  'unroll',
  'no_unroll',
  'parallel',
  'no_fuse',
...
export const SUPPORTED_ADVANCED_STATEMENTS = new Set<string>([
...
export const PRAGMA_HANDLERS = new Map<string, AdvancedStatementHandler>([
  ['route', handleRoute],

...
### Compact Extended Syntax (Custom Operation)
...
- **Parser:** `src/parser/pragma-parser.ts` (`parseRoutePragmaArgs`)
- **Generator:** `src/parser/route-generator.ts` (`generateRouteTokens`)
